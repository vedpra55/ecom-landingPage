        ...
        {data.map((item, i) => (
          ...
          >
            ...
            <div className="z-10 absolute inset-0 py-2 md:py-5 gap-y-1 md:gap-y-[15px] flex flex-col text-white justify-end items-start px-2 md:px-[25px] h-full">
              ...
              <button className="btnHover hover:bg-red-600  active:bg-red-800 lg:w-[172px] lg:h-[44px] flex justify-center items-center bg-main rounded-[90px]   md:w-auto text-[15px] md:text-[16px] px-5 py-1  font-semibold  whitespace-nowrap lg:px-[52px]">
                В каталог
              </button>
            </div>
